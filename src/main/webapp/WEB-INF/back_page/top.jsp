                     ...
                     <div class="login-welcome">
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <img src="/res/itcast/img/admin/loginout-icon.png"/><a href="javascript:void(0)" target="_top" id="logout" onclick="return confirm('您确定退出吗?');">退出</a> 
                              ...
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
										...
										<li class="sep"></li><li class="current" id="tb_12" onclick="HoverLi(12);"><a href="/frame/product_main.do" target="mainFrame">商品管理</a></li>
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(13);"><a href="/frame/order_main.do" target="mainFrame">订单管理</a></li>
